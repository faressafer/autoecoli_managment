...
export default function MainLayout({
  ...
  const { signOut, user, userProfile, autoEcole, isSuperAdmin, adminProfile } = useAuth();
  ...
  const navigation = [
    ...
    },
    {
      ...
      subItems: [
        ...
        {
          name: "Signature Electronique Autoecoli",
          href: "/juridique/signature-electronique",
        },
        {
          name: "Cout a payer",
          href: "/juridique/cout-a-payer",
        },
      ],
    },
    {
